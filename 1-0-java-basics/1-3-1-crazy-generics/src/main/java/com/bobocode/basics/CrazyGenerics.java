...
public class CrazyGenerics {
     ...
     */
    interface CollectionRepository<T extends BaseEntity, C extends Collection<T>> { // todo: update interface according
        // to the
        // javadoc
        void save(T entity);
     ...
     * @param <T> – a type of the entity that should be a subclass of {@link BaseEntity}
     */
    interface ListRepository<T extends BaseEntity> extends CollectionRepository<T, List<T>> { // todo:
        // update
        // interface
        // according
        // to
    ...
    interface ComparableCollection<E> extends Collection<E>, Comparable<Collection<?>> { //
        ...
        // todo: refactor it to make generic
        // and
        // provide a
        // default
        // impl of
    ...
    static class CollectionUtil {
         ...
         */
        public static <T> Optional<? extends T> findMax(Collection<? extends T> elements,
